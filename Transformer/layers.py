...
if __name__ == '__main__':
    ...
    # print(f'forwarded_positional_emb = {forwarded_positional_emb.size()}')    #             [max_len, d_model]
                                                                              # 두 개 더하면 broadcast 됨 => # [batch_size, max_len, d_model]
    ...
    # forwarded_encoder_block = encoder_block(forwarded_transformer_emb, None)   # mask 모양 어덯게 돼야하는지 ?
