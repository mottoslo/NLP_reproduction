...
if __name__ == '__main__':
    ...
    checkpoint = torch.load('./results/trasformer_currentmodel', map_location = device)
    model = Transformer(cfg.src_pad_idx, cfg.trg_pad_idx, cfg.trg_sos_idx, cfg.enc_voc_size, cfg.dec_voc_size,
                      cfg.d_model, cfg.n_head, cfg.max_len, cfg.ffn_hidden, cfg.n_layers, cfg.drop_prob, device)
